...
public class SupplyCatalog {
    ...
    public List<SupplyRoute> routesFor(Requirement requirement, AccountContext context) {
        ...
        addKnownRoutes(routes, itemName, quantity);
        routes.add(SupplyRoute.grandExchange(itemName, quantity, 0, 1.25));
        return routes;
    }

    private void addKnownRoutes(List<SupplyRoute> routes, String itemName, int quantity) {
        ...
        switch (normalized) {
            ...
            case "lobster pot":
            case "harpoon":
                routes.add(SupplyRoute.shop(itemName, quantity, "Gerrant", PORT_SARIM_FISHING_SHOP, 50));
                break;
            case "bronze axe":
            case "iron axe":
            case "steel axe":
            ...
            case "mithril axe":
            case "adamant axe":
                routes.add(SupplyRoute.shop(itemName, quantity, "Bob", LUMBRIDGE_AXE_SHOP, 20));
                break;
            case "bronze pickaxe":
            case "iron pickaxe":
            case "steel pickaxe":
            ...
            case "adamant pickaxe":
                routes.add(SupplyRoute.shop(itemName, quantity, "Nurmof", DWARVEN_MINE_PICKAXE_SHOP, 50));
                break;
            case "shortbow":
            case "longbow":
            case "oak shortbow":
            ...
            case "adamant scimitar":
                routes.add(SupplyRoute.shop(itemName, quantity, "Zeke", AL_KHARID_SCIMITAR_SHOP, 1000));
                break;
            default:
                break;
        }
