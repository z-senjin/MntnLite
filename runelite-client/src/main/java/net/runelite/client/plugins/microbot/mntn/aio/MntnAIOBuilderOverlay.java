...
public class MntnAIOBuilderOverlay extends OverlayPanel {
    ...
    private void configureSkills(MntnBuilderOverlayState state) {
        List<MntnAIOBuilderOverlayActionGrid.Action> actions = new ArrayList<>();
        for (Skill skill : Skill.values()) {
            if ("Overall".equals(skill.getName())) {
                continue;
            }
            actions.add(new MntnAIOBuilderOverlayActionGrid.Action(skillIconManager.getSkillImage(skill, true),
